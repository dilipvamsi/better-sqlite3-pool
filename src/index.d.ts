...
declare module "better-sqlite3-pool" {
  ...
  export class Database extends EventEmitter {
     ...
     * Use this to check if you are currently running within a `db.transaction()` block.
     */
    ...
    attach(
      filename: string,
      alias: string,
      options?: Database.AttachOptions,
    ): Promise<void>;
...
// =============================================================================
// ADAPTER MODULE (node-sqlite3 compatibility)
// =============================================================================
